...
*/
	...
	/*
	300 Multiple Choices (ћножество выборов).
	301 Moved Permanently (ѕеремещено окончательно).
	302 Found (Ќайдено).
	303 See Other (—мотреть другое).
	304 Not Modified (Ќе измен€лось).
	305 Use Proxy (»спользовать прокси).
	306 (зарезервировано).
	307 Temporary Redirect (¬ременное перенаправление).
	*/
