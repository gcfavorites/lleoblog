...
<p>текст1:<br><textarea name=txt1 cols=80 class=t>".htmlspecialchars($txt1)."</textarea>
<br>текст2:<br><textarea name=txt2 cols=80 class=t>".htmlspecialchars($txt2)."</textarea>
