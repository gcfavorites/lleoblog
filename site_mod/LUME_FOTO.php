...
SCRIPT_ADD("js/prototype.js");
SCRIPT_ADD("js/scriptaculous.js?load=effects,builder");
SCRIPT_ADD("js/lightbox.js");
*/

function LUME_FOTO($e) {
   return "<div class='photo'><a href='".$e."' rel='lightbox[things]'><img src='".str_replace('-image-','-thumb-',$e)."' /></a></div>";
}
