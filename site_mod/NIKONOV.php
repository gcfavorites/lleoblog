...
самые кривые руки мира последних трех лет.</i></font>";
	} else return "<p><center><a href='$url'>...читать продолжение этого материала на ".NIKONOVU($url)."</a></center><p>";
}

// --- solidarnost.org ---
if(strstr($url,'solidarnost.org')) {
	return "<p><center><a href='$url'>...читать продолжение этого материала на ".NIKONOVU($url)."</a></center><p>";
}
