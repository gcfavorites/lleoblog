...
<img alt='Фотоальбом' class=knop onClick=\"majax('foto.php',{a:'album'})\" src=".$www_design."e3/foto.png>
<img alt='Найти все фотки,<br>неопубликованные за этот месяц<br>и вставить в заметку' class=knop onclick=\"majax('foto.php',{a:'lostfoto',idhelp:'".$idhelp."'})\" src='".$www_design."e3/ledlightblue.png' alt='Find lost foto'>
&nbsp;&nbsp;
<img alt='Справка' class=knop onclick=\"majax('editor.php',{a:'loadhelp'})\" src='".$www_design."e3/gnome-help.png' alt='Help!'>
&nbsp;&nbsp;"
...
<img class=knop onClick=\"ti('$id','<table style=\'border-collapse: collapse; border: 1px solid red; margin: 20pt;\' bgcolor=#fffff0 border=1 cellpadding=20><td><div align=justify>{select}</td></table>')\" src=".$www_design."e2/tableb_r.gif>
...
<img class=knop title='Find/Replace' onClick=\"majax('editor.php',{a:'findreplace',id:'$id'})\" src=".$www_design."e3/kviewshell.png>
","\n","");
?>