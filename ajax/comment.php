...
"<div style='display:inline' class='myunic'>ввести имя: <input name='name' class='in' type='text'> <input tiptitle='Залогиниться по-быстренькому,<br>не покидая страницы' value='или залогиниться' onclick=\"ifhelpc('".$GLOBALS['httphost']."login','logz','Login')\" type='button'></div>"
)."
</div><div class=l2>"
