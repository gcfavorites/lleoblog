...
$num=intval($_POST['num']); if(!$num) idie("Сбой.<p>".h($text));

$s .= "<b>Оставить комментарий:</b>
<form method=post action='".$wwwhost."module/get_comment_from_loh_noJS'>
<input type=hidden name=num value='$num'>
<table>
<tr><td>Имя:</td><td><input class=t type=text name='name' size=40 maxlength=128 value='".h($name)."'></td></tr>
<tr><td>Mail для ответа (скрыт):</td><td><input class=t type=text name='mail' size=40 maxlength=128 value='".h($mail)."'></td></tr>
