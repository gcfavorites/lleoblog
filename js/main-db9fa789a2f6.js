...
function c_save(n,v,d) { if(v===false||v===null) return false; var N=new Date(); N.setTime(N.getTime()+(v==''?-1:3153600000000)); document.cookie=n+'='+encodeURIComponent(v)+';expires='+N.toGMTString()+';path=/;'+(d!==0?'domain=.'+MYHOST+';':''); }
...
function bigfoto(i,p){ var Z=(p==undefined);
	...
	var navl=Z?'':"<div id='bigfotol' style='position:absolute;top:0px;left:0px;'"+((!i)?'>':" title='prev' onclick='bigfoto(bigtoti-1,bigtotp)' onmouseover=\"otkryl('bigfotoli')\" onmouseout=\"zakryl('bigfotoli')\"><img id='bigfotoli' style='position:absolute;top:0px;left:3px;display:none;' src='"+www_design+"img/DiKiJ_l.png'>")+"</div>";
	var navr=Z?'':"<div id='bigfotor' style='position:absolute;top:0px;right:0px;'"+((g==i+1)?'>':" title='next' onclick='bigfoto(bigtoti+1,bigtotp)' onmouseover=\"otkryl('bigfotori')\" onmouseout=\"zakryl('bigfotori')\"><img id='bigfotori' style='position:absolute;right:3px;display:none;' src='"+www_design+"img/DiKiJ_r.png'>")+"</div>";
