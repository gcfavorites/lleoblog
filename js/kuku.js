playswf=function(a){ var s=www_design+'mp3playerns.swf?autostart=yes&file='+a+'.mp3';
...
saytime=function(e){
	...
	setTimeout("playswf(www_design+'kuku/s0');",t);
	setTimeout("playswf(www_design+'kuku/s"+((Math.floor(Math.random()*10)+1)%24)+"')",t+2000);
	setTimeout("playswf(www_design+'kuku/'"+(new Date().getHours()+1)+"'); saytime();",t+4000);
}
