...
<img class=knop onClick=\"pns('BodyTextarea','<p class=pd>','')\" src=".$www_design."e2/pd.gif>
<img class=knop onClick=\"pns('BodyTextarea','<p class=d>','')\" src=".$www_design."e2/d.gif>
<img class=knop onClick=\"pns('BodyTextarea','".chr(160)."','')\" src=".$www_design."e2/nbsp.gif>
<img class=knop onClick=\"pns('BodyTextarea','".chr(169)."','')\" src=".$www_design."e2/copy.gif>
<img class=knop onClick=\"pns('BodyTextarea','".chr(151)."','')\" src=".$www_design."e2/mdash.gif>
<img class=knop onClick=\"pns('BodyTextarea','".chr(171)."','".chr(187)."')\" src=".$www_design."e2/ltgt.gif>
<img class=knop onClick=\"pns('BodyTextarea','<b>','</b>')\" src=".$www_design."e2/bold.gif>
<img class=knop onClick=\"pns('BodyTextarea','<i>','</i>')\" src=".$www_design."e2/italic.gif>
<img class=knop onClick=\"pns('BodyTextarea','<s>','</s>')\" src=".$www_design."e2/strikethrough.gif>
<img class=knop onClick=\"pns('BodyTextarea','<u>','</u>')\" src=".$www_design."e2/underline.gif>
<img class=knop onClick=\"pns('BodyTextarea','\\n<center>','</center>')\" src=".$www_design."e2/justifycenter.gif>
<img class=knop onClick=\"pns2('BodyTextarea','\\n<img src=".$www_design."e2/lj.gif style=\'vertical-align: middle;\'><a href=http://','.livejournal.com>','</a>')\" src=".$www_design."e2/ljuser.gif>
<img class=knop onClick=\"pns('BodyTextarea','<p><center><img src=',' border=1></center>')\" src=".$www_design."e2/image.gif>
<img class=knop onClick=\"pns2('BodyTextarea','<a href=','>','</a>')\" src=".$www_design."e2/link.gif>
